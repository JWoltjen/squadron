    ...
    return (
        <div className='history-container'>
            <div className='history-card'>
                <h1 className='history-title'>A History of the Bloody Red Squadron</h1>
                <p>The squadron was formed within the War Thunder Arcade Beta community in June 2013. At the time, War Thunder was a new free to play massive-multiplayer online game for the PC which focused on World War II aviation. The Bloody Red Squadron (known by its in-game insignia =oBRSo=) became known for its elite cadre of so-called "Realistic Battles" pilots, especially within the nascent War Thunder jet community. At the time, the jet scene was very exclusive territory, and as a consequence, it became easy for players to become acquainted with each other. New friends and adversaries were made as F-86 Sabre flew against MiG-15bis over the skies of Korea over and over again.</p>
                <h2 className='history-subtitle'>2013-2014: The Beginning</h2>
